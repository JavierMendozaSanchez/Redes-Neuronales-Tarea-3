...
Original file is located at
    https://colab.research.google.com/drive/1wXi_anp0iNEjoMmTYcMgwm032QWIjyBx
"""
...
model = Sequential()
#inplementacion del ambos regularizadores l1 y l2
model.add(Dense(100, activation='sigmoid', input_shape=(784,), kernel_regularizer=regularizers.L1L2(l1=1e-5, l2=1e-4)))
...
experiment_name = "L1-L2" #lo nombramos a nuestro gusto
...
with mlflow.start_run(experiment_id=experiment_id, run_name="L1-L2"):
