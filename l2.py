...
Original file is located at
    https://colab.research.google.com/drive/15KMEgPLch9eZ3JtgDl0mJM4rD_e_M8_V
"""
...
model = Sequential()
#inplementacion del regularizador l2
model.add(Dense(100, activation='sigmoid', input_shape=(784,), kernel_regularizer=regularizers.L2(l2=1e-4)))
...
experiment_name = "L2" #lo nombramos a nuestro gusto
...
with mlflow.start_run(experiment_id=experiment_id, run_name="L2"):
