...
Original file is located at
    https://colab.research.google.com/drive/1sY7_1kqsB2yWc8gGio1M_yIE4-bqEUV0
"""
...
model = Sequential()
#inplementacion del regularizador L1
model.add(Dense(100, activation='sigmoid', input_shape=(784,), kernel_regularizer=regularizers.L1(0.01)))
...
experiment_name = "L1" #lo nombramos a nuestro gusto
...
with mlflow.start_run(experiment_id=experiment_id, run_name="L1"):
