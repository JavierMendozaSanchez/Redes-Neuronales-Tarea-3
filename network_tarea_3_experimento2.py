# -*- coding: utf-8 -*-
"""Network_Tarea_3_Experimento2

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1xMZnUStG3FAUyKf3d0961UWIwgqiFjSp
"""
...
model = Sequential()
#la capa oculta tendra ahora 128 neuronas
model.add(Dense(128, activation='sigmoid', input_shape=(784,)))
#le agregamos otra capa ahora de 64 neuronas
...
experiment_name = "Experimento 2" #lo nombramos a nuestro gusto
...
with mlflow.start_run(experiment_id=experiment_id, run_name="Experimento 2"):
    #cambiamos de optimizador a ADAM
